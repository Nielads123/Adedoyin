...
export default function BodyOne() {
  return (
    <>
      <div className="flex flex-col lg:flex-row items-center justify-between py-16 lg:mt-[-130px] bg-[#352f2f]">
        
        {/* left */}
        <div
          className="ml-[20px] lg:ml-[40px] text-center lg:text-left"
          data-aos="fade-right"
        > 
          <div className="text-[25px] md:text-[40px] lg:text-[50px] lg:mt-[300px] font-bold font-poppins text-white">
            We Provide Architectural design and Construction
          </div>

          <div className="font-poppins my-6 mt-[20px] text-white text-[14px] md:text-[16px]">
            More than 100 building and housing projects that we have built. <br /> 
            The building owner chose us over other contractors in Nigeria, <br /> 
            because our work is different
          </div>

          <div
            className="font-poppins cursor-pointer bg-gradient-to-r from-[#5c3d2e] to-[#352f2f] text-white px-6 py-4 mt-[20px] rounded-sm inline-block"
            data-aos="zoom-in"
          > 
            Discover More
          </div>
          ...
          {/* numbers */}
          <div
            className="flex flex-col sm:flex-row sm:space-x-12 py-10 justify-center lg:justify-start space-y-6 sm:space-y-0"
            data-aos="fade-up"
          >
            {/* one */}
            <div className="block">
        ...
        {/* right */}
        <div
          className="relative w-full flex justify-center mt-3 lg:mt-0"
          data-aos="fade-left"
        >
          {/* image */}
          <img 
          ...
          {/* card */}
          <div
            className="absolute bottom-[-20%] md:space-y-12 md:pt-[44px] md:bottom-[-15%] md:w-[750px] lg:h-[150px] md:h-[450px] lg:bottom-[-12%] bg-gradient-to-r from-[#5c3d2e] to-[#352f2f] text-white p-6 lg:py-12 lg:pl-[16px] rounded-sm w-[90%] sm:w-[500px] lg:w-[671px] mx-auto flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-8"
            data-aos="fade-up"
          >
            {/* one */}
