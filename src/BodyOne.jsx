    ...
    <>
      <div className="flex flex-col lg:flex-row items-center justify-between py-16 lg:mt-[-130px] bg-[#352f2f] ">
        ...
        <div className="relative w-full flex justify-center mt-3 lg:mt-0">
          ...
          {/* card */}
          <div className="absolute bottom-[-20%] md:space-y-12 md:pt-[44px] md:bottom-[-15%] md:w-[750px] lg:h-[150px] md:h-[450px] lg:bottom-[-12%] bg-gradient-to-r from-[#5c3d2e] to-[#352f2f] text-white p-6 lg:py-12 lg:pl-[16px] rounded-sm w-[90%] sm:w-[500px] lg:w-[671px] mx-auto flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-8">
